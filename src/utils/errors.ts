 ...
 *
 * Custom error classes and error handling helpers for Loom API.
 */
 ...
 */
export class RateLimitError extends LoomApiError {
 ...
 */
export class AuthenticationError extends LoomApiError {
 ...
 * Not found error
 */
export class NotFoundError extends LoomApiError {
 ...
 * Validation error
 */
export class ValidationError extends LoomApiError {
